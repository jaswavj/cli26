...
try {
    ...
    customer.updateCustomer(customerId, customerName, phoneNumber, address, notes);
    response.sendRedirect(request.getContextPath() + "/customer/master/page.jsp?msg=Customer+updated+successfully&type=success");
} catch (Exception e) {
    e.printStackTrace();
